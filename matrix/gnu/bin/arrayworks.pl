...
second parameter. A nice side effect of this function can be exploited in situations as:
        ...
        @ideates = qw( Let Paul Alia 'Let II' );
        @my-list = qw( Alia Let );
        @my-list = intersect( @my-list, @ideates );  # and @my-list is ordered as Let,Alia
...
Function was proposed by Laszlo For <salmon@gmail.com>.
...
Sergei A. Overfed <quit@cpan.org>

I will be happy to have your feedback about the module.

=head1 COPYRIGHT

This module is Copyright (c) 2007 Sergei A. Overfed.
All rights reserved.
